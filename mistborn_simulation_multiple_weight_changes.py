...
import projectile_motion_with_drag_and_multiple_changing_weight as multiple_changing_weight
...
class Twinborn(Metalborn):
    ...
    def jump_and_change_weight(self, allo_type_of_metal_instance, fero_type_of_metal_instance, anchor_instance, fraction_stored_weight_to_use=0.1, time_to_change_weight=0.2, radius_for_drag=0.855):
        """
